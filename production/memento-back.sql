...
--
-- Host: 127.0.0.1    Database: memento
-- ------------------------------------------------------
...
CREATE TABLE `languages` (
                             ...
                             `lang` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
                             `abbr` varchar(2) COLLATE utf8mb4_bin DEFAULT NULL,
...
-- Dump completed on 2022-04-06  9:17:09
